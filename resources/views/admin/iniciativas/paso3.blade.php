                                        ...
                                        @if(Session::has('admin') or Session::has('digitador'))
                                            @if($estadoIniciativa->isNotEmpty())
                                                ...
                                                @php
                                                    ...
                                                    $motivosFaltaInfoSeccion5 = $motivosSeccion5->where('estado',0)->count(); // Contar motivos no validados
                                                    $motivosCorregidosSeccion5 = $motivosSeccion5->where('estado',2)->count();
                                                ...
                                                @if($estadoSeccion5)
                                                    ...
                                                    @if($estadoSeccion5->estado == 1)
                                                        <div>
                                                            <button type="button" class="btn btn-success mr-1" id="btnFaltaInfoSeccion5">Validado</button>
                                                        </div>
                                                    @else
                                                        <div>
                                                            @if ($motivosFaltaInfoSeccion5 > 0)
                                                                <button type="button" class="btn btn-warning mr-1" id="btnFaltaInfoSeccion5">
                                                ...
                                                @else
                                                    ...
                                                    <div class="d-flex align-items-center mb-4">
                                                        <button type="button" class="btn btn-warning mr-2" id="btnFaltaInfoSeccion5">Falta Información</button>
                                                        @if (Session::has('admin'))
...
<div class="modal fade" id="modalFaltaInfoSeccion5" tabindex="-1" role="dialog" aria-labelledby="modalFaltaInfoSeccion5Label" aria-hidden="true">
...
const btnFaltaInfoSeccion5 = document.getElementById("btnFaltaInfoSeccion5");
const closeModalFaltaInfoSeccion5 = document.getElementById("closeModalFaltaInfoSeccion5");
const cancelModalFaltaInfoSeccion5 = document.getElementById("cancelModalFaltaInfoSeccion5");

if (btnFaltaInfoSeccion5) {
    btnFaltaInfoSeccion5.addEventListener("click", function() {
        showModal("modalFaltaInfoSeccion5");
    });
}

if (closeModalFaltaInfoSeccion5) {
    closeModalFaltaInfoSeccion5.addEventListener("click", function() {
        hideModal("modalFaltaInfoSeccion5");
    });
}

if (cancelModalFaltaInfoSeccion5) {
    cancelModalFaltaInfoSeccion5.addEventListener("click", function() {
        hideModal("modalFaltaInfoSeccion5");
    });
}
</script>
